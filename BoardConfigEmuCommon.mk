...
BUILD_EMULATOR_OPENGL_RNBOX := true
BUILD_QEMU_IMAGES_RNBOX := true
...
DEVICE_MATRIX_FILE   := device/rnbox/goldfish/compatibility_matrix.xml

BOARD_SEPOLICY_DIRS += device/rnbox/goldfish/sepolicy/common
